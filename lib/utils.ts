...
export type FraudReportStatus = typeof FRAUD_REPORT_STATUSES[keyof typeof FRAUD_REPORT_STATUSES]
export type DonationFrequency = typeof DONATION_FREQUENCIES[keyof typeof DONATION_FREQUENCIES]
...
export function validateCampaignData(data: any): { isValid: boolean; errors: string[] } {
  const errors: string[] = []
