      ...
      try {
        ...
        dispatch({
          ...
          payload: {
            preferences: {
              emailNotifications:
                state.profile?.preferences?.emailNotifications ?? true,
              smsNotifications:
                state.profile?.preferences?.smsNotifications ?? false,
              marketingEmails:
                state.profile?.preferences?.marketingEmails ?? false,
              publicProfile: state.profile?.preferences?.publicProfile ?? true,
